...
import {AboutView} from '../drawer/about';
import {RootStackModalView} from '../primary/elsa/screens/root-stack-modal/modal';
...
// };
// (2)
type ModalScreenProps = StackScreenProps<RootStackParamList, 'Modal'>; // import {StackScreenProps} from '@react-navigation/stack';
export const ModalScreen = ({navigation, route}: ModalScreenProps) => {
  React.useEffect(() => {
